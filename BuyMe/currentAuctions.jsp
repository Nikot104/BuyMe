...
<body>
	...
	<div class="clearfix">
  		<div class="box" style="background-color:#bbb">
   			 <p><a href = "editAccount.jsp">Edit Account</a></p>
  		</div>
	...
	try{
		...
		String str1 = "SELECT * FROM Headphone_Auctions WHERE user_id = \'" + session.getAttribute("user")
		+ "\'";
		String str2 = "SELECT * FROM Cellphone_Auctions WHERE user_id = \'" + session.getAttribute("user")
		+ "\'";
		String str3 = "SELECT * FROM Computer_Auctions WHERE user_id = \'" + session.getAttribute("user")
		+ "\'";
